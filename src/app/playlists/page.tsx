...
const PlaylistCard = ({ playlist }: { playlist: GenrePlaylist }) => (
    <Link href={`/playlists/${playlist.id}`} className="block">
        <div className="group relative bg-neutral-900/40 backdrop-blur-sm border border-white/5 rounded-3xl overflow-hidden hover:border-purple-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-900/20 hover:-translate-y-2 cursor-pointer h-full">
            {/* Cover Image */}
