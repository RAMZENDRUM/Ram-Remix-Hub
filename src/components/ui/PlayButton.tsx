...
export function PlayButton({ isPlaying, onClick, variant = "pill", label, className }: PlayButtonProps) {
    return (
        <button
            ...
            className={cn(
                "inline-flex items-center justify-center gap-2 border border-white/30 bg-white/10 hover:bg-white/20 backdrop-blur-lg transition-all duration-200 text-white shadow-[0_0_15px_rgba(255,255,255,0.1)] active:scale-95",
